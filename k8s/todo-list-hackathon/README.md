...
This chart bootstraps a [Todo List Hackathon](https://github.com/misha-jatt/Todo-hackathon-II) deployment on a [Kubernetes](http://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
